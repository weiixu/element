...
<div class="block">
  ...
  <g-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></g-cascader>
</div>
<div class="block">
...
:::demo
```html
<g-cascader :options="options" clearable></g-cascader>
...
```html
<g-cascader :options="options" :show-all-levels="false"></g-cascader>
...
```html
<g-cascader :props="props"></g-cascader>
...
```html
<g-cascader-panel :options="options"></g-cascader-panel>
