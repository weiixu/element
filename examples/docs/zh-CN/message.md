...
```html
<template>
  <gj-button :plain="true" @click="open2">成功</gj-button>
  <gj-button :plain="true" @click="open3">警告</gj-button>
  <gj-button :plain="true" @click="open1">消息</gj-button>
  <gj-button :plain="true" @click="open4">错误</gj-button>
</template>
