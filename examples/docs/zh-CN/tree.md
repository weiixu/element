...
:::demo
```html
<g-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></g-tree>
...
<div class="buttons">
  <g-button @click="getCheckedNodes">通过 node 获取</g-button>
  <g-button @click="getCheckedKeys">通过 key 获取</g-button>
  <g-button @click="setCheckedNodes">通过 node 设置</g-button>
  <g-button @click="setCheckedKeys">通过 key 设置</g-button>
  <g-button @click="resetChecked">清空</g-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <g-button size="mini" type="text" on-click={ () => this.append(data) }>Append</g-button>
              <g-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</g-button>
            </span>
          </span>);
      }
    }
