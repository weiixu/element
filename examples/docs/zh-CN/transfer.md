...
```html
<template>
  <gj-transfer v-model="value" :data="data"></gj-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <gj-transfer
      ...
      @change="handleChange"
      :data="data">
      <gj-button class="transfer-footer" slot="left-footer" size="small">操作</gj-button>
      <gj-button class="transfer-footer" slot="right-footer" size="small">操作</gj-button>
    </gj-transfer>
  </div>
