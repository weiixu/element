...
```html
<template>
  <g-transfer v-model="value" :data="data"></g-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <g-transfer
      ...
      @change="handleChange"
      :data="data">
      <g-button class="transfer-footer" slot="left-footer" size="small">操作</g-button>
      <g-button class="transfer-footer" slot="right-footer" size="small">操作</g-button>
    </g-transfer>
  </div>
